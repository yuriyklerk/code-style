...
1. Комментарии в отличии от нужно делать обширными, но не везде где вздумается, поскольку код сам по себе должен быть ясен по названию функций и переменных. НЕОБХОДИМО комментировать описание классов.

2. Некоторые функции также НЕОБХОДИМО комментировать, особенно если они требуют параметры ввода.
